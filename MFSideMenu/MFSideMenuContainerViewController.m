...
- (void)setCenterViewController:(UIViewController *)centerViewController {
    ...
    centerViewController.view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
...
- (void)setUserInteractionStateForCenterViewController {
    ...
    if([self.centerViewController respondsToSelector:@selector(viewControllers)]) {
        NSArray *viewControllers = [(UINavigationController *)self.centerViewController viewControllers];
